...
import type { AccountCategory, CustomerGroupOption, DataDictionary, OperationAccount, SimpleCategory } from '@/api/types'
...
const customerGroups = ref<CustomerGroupOption[]>([])
...
async function loadMetadata() {
  ...
  pushDraft()
  try {
    const [categories, accounts, cGroups, gCategories, cCustomerGroups, dicts, settings] = await Promise.all([
    ...
    customerGroups.value = cCustomerGroups
