...
export interface CustomerLookupBatch { id:number; batchTaskId?:number|null; name:string; mode:string; accountSource:string; status:string; total:number; completed:number; found:number; notFound:number; failed:number; queryPreview?:string|null; createdAt:string; startedAt?:string|null; completedAt?:string|null; lastHeartbeatAt?:string|null }
